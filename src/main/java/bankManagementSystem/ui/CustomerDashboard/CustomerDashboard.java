...
public class CustomerDashboard extends JFrame {
    ...
    private JPanel buildSidebar() {
        ...
        String[] opts = {"Dashboard", "Send Money", "Transactions", "Loan Application", "Profile Settings", "Support"};
    ...
    private void switchPanel(String key) {
        ...
        switch (key) {
            case "Dashboard":
                ...
                break;
            case "Send Money":
                mainContentPanel.add(placeholder("Send Money (Under Development)"), BorderLayout.CENTER);
                break;
            case "Transactions":
                mainContentPanel.add(new TransactionData(), BorderLayout.CENTER);
                break;
            case "Loan Application":
                mainContentPanel.add(placeholder("Loan Application (Under Development)"), BorderLayout.CENTER);
                break;
            case "Profile Settings":
                mainContentPanel.add(placeholder("Profile Settings (Under Development)"), BorderLayout.CENTER);
                break;
            case "Support":
                mainContentPanel.add(placeholder("Support (Under Development)"), BorderLayout.CENTER);
                break;
            default:
                mainContentPanel.add(placeholder("Unknown Section"), BorderLayout.CENTER);
        }
