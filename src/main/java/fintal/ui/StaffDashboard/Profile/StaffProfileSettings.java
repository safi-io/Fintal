package main.java.fintal.ui.StaffDashboard.Profile;
...
public class StaffProfileSettings extends JPanel {
    ...
    public StaffProfileSettings(int staffId) {
    ...
    private void loadStaffData(int staffId) {
        StaffModel staff = staffController.handleGetStaffById(staffId);

        if (staff != null) {
            setNameText(staff.getStaffName());
            setEmailText(staff.getStaffMail());
            setPhoneText(staff.getStaffPhone());
            clearPassword();
